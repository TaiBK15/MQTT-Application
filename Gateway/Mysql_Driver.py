...
class MysqlQuery:
    ...
    def createTable(self, device_tab):
        try:
            sql_create_table = "CREATE TABLE " + device_tab + "( `ID` INT(255) NOT NULL AUTO_INCREMENT ,\
            ...
            print("create table " + device_tab +" successfully!")
        except mysql.connector.Error as error:
    ...
    def insertTable(self,device_tab, temp, humid, bri):
        try:
            sql_insert_query = "INSERT INTO "+ device_tab + \
                 "(TEMPERATURE, HUMIDITY, BRIGHTNESS) VALUES('" + temp + "', '" + \
                                                                  humid + "', '" + \
                                                                  bri + "')"
